...
const T = {
  ...
  ru: {
    ...
    partner: {
      ...
      minBal: "Недостаточно баланса для вывода.", fConfirm: "Подтвердите пароль", passMismatch: "Пароли не совпадают.", passShort: "Пароль должен быть не менее 6 символов.", msgsTitle: "Сообщения", noMsgs: "Сообщений пока нет.", editCode: "Изменить код", codeLabel: "Ваш реферальный код", codeHint: "Минимум 6 символов — буквы и цифры", codeShort: "Минимум 6 символов.", codeInvalid: "Только буквы и цифры.", codeTaken: "Этот код занят.", codeOk: "Свободен.", codeSaved: "Код обновлён!", checkEmail: "Ссылка для подтверждения отправлена на вашу почту. Проверьте почту, перейдите по ссылке, затем войдите.", earnForEach: "Зарабатывайте за каждого студента", save: "Сохранить", cancel: "Отмена"
    },
  ...
  ar: {
    ...
    partner: {
      ...
      minBal: "الرصيد غير كافٍ للسحب.", fConfirm: "أكد كلمة المرور", passMismatch: "كلمتا المرور غير متطابقتين.", passShort: "يجب ألا تقل كلمة المرور عن 6 أحرف.", msgsTitle: "الرسائل", noMsgs: "لا رسائل بعد.", editCode: "تعديل الرمز", codeLabel: "رمز الإحالة الخاص بك", codeHint: "6 أحرف على الأقل — حروف وأرقام", codeShort: "يجب ألا يقل عن 6 أحرف.", codeInvalid: "استخدم الحروف والأرقام فقط.", codeTaken: "هذا الرمز مستخدم.", codeOk: "متاح.", codeSaved: "تم تحديث الرمز!", checkEmail: "تم إرسال رابط التأكيد إلى بريدك. تحقق من بريدك وانقر على الرابط ثم سجّل الدخول.", earnForEach: "اربح دخلاً عن كل طالب", save: "حفظ", cancel: "إلغاء"
    },
