      ...
      {menu && (
        <div className="overlay">
          ...
          <div className="wrap ov-links">
            {[["home", t.nav.home], ["universities", t.nav.universities], ["about", t.nav.about], ["contact", t.nav.contact]].map(([p, label], i) => (
        ...
        <div className="login">
          ...
          <div className="field" style={{ marginBottom: 12 }}>
            ...
            <input type="password" value={pw} autoFocus onChange={e => { setPw(e.target.value); setErr(false); }}
              onKeyDown={e => { if (e.key === "Enter") { if (pw === PASSWORD) setAuthed(true); else setErr(true); } }} />
          </div>
          {err && <div style={{ color: "var(--coral)", fontWeight: 700, marginBottom: 12 }}>{t.admin.wrong}</div>}
          <button className="btn btn-teal" style={{ width: "100%", justifyContent: "center" }} onClick={() => { if (pw === PASSWORD) setAuthed(true); else setErr(true); }}>{t.admin.enter}</button>
      ...
      <div className="wrap">
        <div className="atop">
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
            ...
            <button className="btn btn-out" onClick={() => go("home")}><LogOut size={16} />{t.admin.logout}</button>
          </div>
        </div>
